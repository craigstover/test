...
const MUSEUM_SOURCES = [
  ...
  { name: 'Studio Museum in Harlem', url: 'https://www.studiomuseum.org/exhibitions-and-events' },
  ...
  { name: 'Longhouse Reserve',  url: 'https://longhouse.org/pages/programs' },
  ...
  { name: 'Kleinert/James Center', url: 'https://www.woodstockguild.org/current-upcoming-exhibitions/' },
  // Downtown NYC — LES, East Village, Tribeca, Soho
  { name: 'Karma',                  url: 'https://karmakarma.org/exhibitions' },
  { name: 'Reena Spaulings',        url: 'http://www.reenaspaulings.com/shows.html' },
  ...
  { name: 'The Hole',               url: 'https://thehole.com/exhibitions' },
  { name: 'Shoot the Lobster',      url: 'https://www.shootthelobster.com' },
  { name: 'Company Gallery',        url: 'https://companygallery.us/' },
  ...
  { name: 'Hauser & Wirth',         url: 'https://www.hauserwirth.com/hauser-wirth-exhibitions/?date=current' },
  ...
  { name: 'Team Gallery',           url: 'https://artpil.com/team-gallery/' },
  // Midtown
  ...
  // Art Fairs
  { name: 'Frieze',               url: 'https://www.frieze.com/fairs/frieze-new-york' },
  ...
  { name: 'Art on Paper',         url: 'https://ny.thepaperfair.com/' },
